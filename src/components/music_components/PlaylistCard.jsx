...
// Added onClick prop
const PlaylistCard = ({ data, title, onClick, currentPlaylist }) => {
  ...
  return (
    ...
    >
    <div
      className={`rounded-lg transition-all duration-200 p-2 ${currentPlaylist === playlistName ? "bg-red-700/60" : ""}`}
      ...
      {/* The Link component handles navigation */}
        {cover ? (
          <img
            src={cover}
            alt={playlistName}
            className=" object-cover aspect-square rounded-md mb-2"
          />
        ) : (
